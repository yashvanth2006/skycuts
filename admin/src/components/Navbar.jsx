              ...
              {user && (
                <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
                  ...
                  {[
                    ...
                    { path: '/portfolio', icon: <Film size={18} />, label: 'Portfolio' },
                  ].map(({ path, icon, label }) => (
                    <button
                      key={path}
                      ...
                      className="btn-ghost" 
                      style={{ 
                        justifyContent: 'flex-start', width: '100%', fontSize: 15,
                        background: location.pathname === path ? 'var(--bg-glass)' : 'transparent'
                      }}
                    >
                      {icon} {label}
                    </button>
